          ...
          >
            ...
            <div className="flex flex-wrap gap-3 justify-center md:justify-start mb-8">
              ...
              <div className="relative group">
                ...
                <div className="absolute left-0 top-full mt-2 w-52 glass rounded-xl overflow-hidden opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 shadow-2xl z-20">
